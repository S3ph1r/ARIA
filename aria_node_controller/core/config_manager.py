...
# MinIO Config
MINIO_ENDPOINT = _settings.get("minio_endpoint", "192.168.1.104:9000")
MINIO_ACCESS_KEY = _settings.get("minio_access_key", "minioadmin")
MINIO_SECRET_KEY = _settings.get("minio_secret_key", "minioadmin")
...
def refresh_config():
    ...
    MINIO_ENDPOINT = _s.get("minio_endpoint", "192.168.1.104:9000")
    MINIO_ACCESS_KEY = _s.get("minio_access_key", "minioadmin")
    MINIO_SECRET_KEY = _s.get("minio_secret_key", "minioadmin")
